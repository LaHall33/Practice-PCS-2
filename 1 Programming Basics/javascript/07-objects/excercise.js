...
const muppets = [
  ...
  for (let muppet of muppets) {
    ...
    console.log(output.slice(0, -2));                           // Will print the output.  Slice will cut the comma off at the end of the lines.  (where you want the slice started, where you want the slice to end)
  }
    /* Expected output: firstName - Kermie, lastName - theFrog
                        firstName - Miss, lastName - Piggy
                        firstName - Fozzie, lastName - Bear
                        firstName - Rowlf, lastName - the Dog
